...
import styles from "./test-env-registration-content.module.css";
...
import check from "../../public/registration-form/images/check@2x.png";
...
const BASE_URL = "https://test-env.i11labs.com/i11-cmp-be/api/organization/registration/form/";
      ...
      Details("create", payload)
        .then((res) => {
          if (res.data && res.data?.error) {
            ...
            // setVerified(false);
            setSuccess(true);
            router.push("/dti-dumptruckit/test-env-registration/thankyou/");
            setTimeout(() => {
              setLoading(false);
            }, 1500);
          }
...
export default RegisterFormsTest;
